...
public partial class @VRBindings : IInputActionCollection2, IDisposable
{
    ...
    public struct OculusActions
    {
        ...
        public void SetCallbacks(IOculusActions instance)
        {
            ...
            {
                @Move.started -= m_Wrapper.m_OculusActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_OculusActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_OculusActionsCallbackInterface.OnMove;
                @Turn.started -= m_Wrapper.m_OculusActionsCallbackInterface.OnTurn;
                @Turn.performed -= m_Wrapper.m_OculusActionsCallbackInterface.OnTurn;
                @Turn.canceled -= m_Wrapper.m_OculusActionsCallbackInterface.OnTurn;
                @Jump.started -= m_Wrapper.m_OculusActionsCallbackInterface.OnJump;
                @Jump.performed -= m_Wrapper.m_OculusActionsCallbackInterface.OnJump;
                @Jump.canceled -= m_Wrapper.m_OculusActionsCallbackInterface.OnJump;
                ...
                @Action.started -= m_Wrapper.m_OculusActionsCallbackInterface.OnAction;
                @Action.performed -= m_Wrapper.m_OculusActionsCallbackInterface.OnAction;
                @Action.canceled -= m_Wrapper.m_OculusActionsCallbackInterface.OnAction;
                @ToggleMicrophone.started -= m_Wrapper.m_OculusActionsCallbackInterface.OnToggleMicrophone;
                @ToggleMicrophone.performed -= m_Wrapper.m_OculusActionsCallbackInterface.OnToggleMicrophone;
                @ToggleMicrophone.canceled -= m_Wrapper.m_OculusActionsCallbackInterface.OnToggleMicrophone;
                @PrimaryClick.started -= m_Wrapper.m_OculusActionsCallbackInterface.OnPrimaryClick;
                @PrimaryClick.performed -= m_Wrapper.m_OculusActionsCallbackInterface.OnPrimaryClick;
                @PrimaryClick.canceled -= m_Wrapper.m_OculusActionsCallbackInterface.OnPrimaryClick;
    ...
    private IIndexActions m_IndexActionsCallbackInterface;
    ...
    public struct IndexActions
    {
        ...
        {
            if (m_Wrapper.m_IndexActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_IndexActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_IndexActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_IndexActionsCallbackInterface.OnMove;
                @Turn.started -= m_Wrapper.m_IndexActionsCallbackInterface.OnTurn;
                @Turn.performed -= m_Wrapper.m_IndexActionsCallbackInterface.OnTurn;
                @Turn.canceled -= m_Wrapper.m_IndexActionsCallbackInterface.OnTurn;
                @Jump.started -= m_Wrapper.m_IndexActionsCallbackInterface.OnJump;
                @Jump.performed -= m_Wrapper.m_IndexActionsCallbackInterface.OnJump;
                @Jump.canceled -= m_Wrapper.m_IndexActionsCallbackInterface.OnJump;
                @Dashboard.started -= m_Wrapper.m_IndexActionsCallbackInterface.OnDashboard;
                @Dashboard.performed -= m_Wrapper.m_IndexActionsCallbackInterface.OnDashboard;
                @Dashboard.canceled -= m_Wrapper.m_IndexActionsCallbackInterface.OnDashboard;
                @Action.started -= m_Wrapper.m_IndexActionsCallbackInterface.OnAction;
                @Action.performed -= m_Wrapper.m_IndexActionsCallbackInterface.OnAction;
                @Action.canceled -= m_Wrapper.m_IndexActionsCallbackInterface.OnAction;
                @ToggleMicrophone.started -= m_Wrapper.m_IndexActionsCallbackInterface.OnToggleMicrophone;
                @ToggleMicrophone.performed -= m_Wrapper.m_IndexActionsCallbackInterface.OnToggleMicrophone;
                @ToggleMicrophone.canceled -= m_Wrapper.m_IndexActionsCallbackInterface.OnToggleMicrophone;
                @PrimaryClick.started -= m_Wrapper.m_IndexActionsCallbackInterface.OnPrimaryClick;
                @PrimaryClick.performed -= m_Wrapper.m_IndexActionsCallbackInterface.OnPrimaryClick;
                @PrimaryClick.canceled -= m_Wrapper.m_IndexActionsCallbackInterface.OnPrimaryClick;
    ...
    private IViveActions m_ViveActionsCallbackInterface;
    ...
    public struct ViveActions
    {
        ...
        {
            if (m_Wrapper.m_ViveActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_ViveActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_ViveActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_ViveActionsCallbackInterface.OnMove;
                @Turn.started -= m_Wrapper.m_ViveActionsCallbackInterface.OnTurn;
                @Turn.performed -= m_Wrapper.m_ViveActionsCallbackInterface.OnTurn;
                @Turn.canceled -= m_Wrapper.m_ViveActionsCallbackInterface.OnTurn;
                @Jump.started -= m_Wrapper.m_ViveActionsCallbackInterface.OnJump;
                @Jump.performed -= m_Wrapper.m_ViveActionsCallbackInterface.OnJump;
                @Jump.canceled -= m_Wrapper.m_ViveActionsCallbackInterface.OnJump;
                @Dashboard.started -= m_Wrapper.m_ViveActionsCallbackInterface.OnDashboard;
                @Dashboard.performed -= m_Wrapper.m_ViveActionsCallbackInterface.OnDashboard;
                @Dashboard.canceled -= m_Wrapper.m_ViveActionsCallbackInterface.OnDashboard;
                @Action.started -= m_Wrapper.m_ViveActionsCallbackInterface.OnAction;
                @Action.performed -= m_Wrapper.m_ViveActionsCallbackInterface.OnAction;
                @Action.canceled -= m_Wrapper.m_ViveActionsCallbackInterface.OnAction;
                @ToggleMicrophone.started -= m_Wrapper.m_ViveActionsCallbackInterface.OnToggleMicrophone;
                @ToggleMicrophone.performed -= m_Wrapper.m_ViveActionsCallbackInterface.OnToggleMicrophone;
                @ToggleMicrophone.canceled -= m_Wrapper.m_ViveActionsCallbackInterface.OnToggleMicrophone;
                @PrimaryClick.started -= m_Wrapper.m_ViveActionsCallbackInterface.OnPrimaryClick;
                @PrimaryClick.performed -= m_Wrapper.m_ViveActionsCallbackInterface.OnPrimaryClick;
                @PrimaryClick.canceled -= m_Wrapper.m_ViveActionsCallbackInterface.OnPrimaryClick;
    ...
    private IUnknownActions m_UnknownActionsCallbackInterface;
    ...
    public struct UnknownActions
    {
        ...
        {
            if (m_Wrapper.m_UnknownActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_UnknownActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_UnknownActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_UnknownActionsCallbackInterface.OnMove;
                @Turn.started -= m_Wrapper.m_UnknownActionsCallbackInterface.OnTurn;
                @Turn.performed -= m_Wrapper.m_UnknownActionsCallbackInterface.OnTurn;
                @Turn.canceled -= m_Wrapper.m_UnknownActionsCallbackInterface.OnTurn;
                @Jump.started -= m_Wrapper.m_UnknownActionsCallbackInterface.OnJump;
                @Jump.performed -= m_Wrapper.m_UnknownActionsCallbackInterface.OnJump;
                @Jump.canceled -= m_Wrapper.m_UnknownActionsCallbackInterface.OnJump;
                @Dashboard.started -= m_Wrapper.m_UnknownActionsCallbackInterface.OnDashboard;
                @Dashboard.performed -= m_Wrapper.m_UnknownActionsCallbackInterface.OnDashboard;
                @Dashboard.canceled -= m_Wrapper.m_UnknownActionsCallbackInterface.OnDashboard;
                @Action.started -= m_Wrapper.m_UnknownActionsCallbackInterface.OnAction;
                @Action.performed -= m_Wrapper.m_UnknownActionsCallbackInterface.OnAction;
                @Action.canceled -= m_Wrapper.m_UnknownActionsCallbackInterface.OnAction;
                @ToggleMicrophone.started -= m_Wrapper.m_UnknownActionsCallbackInterface.OnToggleMicrophone;
                @ToggleMicrophone.performed -= m_Wrapper.m_UnknownActionsCallbackInterface.OnToggleMicrophone;
                @ToggleMicrophone.canceled -= m_Wrapper.m_UnknownActionsCallbackInterface.OnToggleMicrophone;
                @PrimaryClick.started -= m_Wrapper.m_UnknownActionsCallbackInterface.OnPrimaryClick;
                @PrimaryClick.performed -= m_Wrapper.m_UnknownActionsCallbackInterface.OnPrimaryClick;
                @PrimaryClick.canceled -= m_Wrapper.m_UnknownActionsCallbackInterface.OnPrimaryClick;
